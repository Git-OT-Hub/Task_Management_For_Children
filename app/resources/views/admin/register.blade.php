    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card shadow">
                <div class="card-header text-center custom-main-color fs-5 text-white">{{ __('admin.register') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('admin/register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-end">{{ __('admin.confirm_password') }}</label>
